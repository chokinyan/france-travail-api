...
export class NatureContratArray{
    ...
    constructor(){
        ...
        this.CodeArray = ["E1" ,"E2" ,"FA" ,"FJ" ,"FS" ,"FT" ,"FU" ,"I1" ,"NS" ,"FV" ,"FW" ,"FX" ,"FY" ,"PS" ,"PR" ,"CC" ,"CU" ,"EE" ,"ER" ,"CI"];
    }
